...
<head>
    ...
    <title>Financial Overview | Ridezo Admin</title>
    ...
    <main class="main-wrapper">
        <div class="page-header">
            ...
            <div class="header-title">
                ...
                <p style="color: var(--text-muted); font-weight: 500;">Monitor system-wide earnings and supplier payouts.</p>
            </div>
        </div>
                        ...
                        <?php if ($transactions->num_rows > 0): ?>
                            <?php while($row = $transactions->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td style="font-weight: 800;">₹<?php echo number_format($row['total_amount'], 0); ?></td>
                                    <td class="amount-positive">₹<?php echo number_format($row['commission'], 0); ?></td>
                                    <td class="amount-primary">₹<?php echo number_format($row['seller_earning'], 0); ?></td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr><td colspan="7" style="text-align: center; padding: 60px; color: var(--text-muted);">No financial records found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
